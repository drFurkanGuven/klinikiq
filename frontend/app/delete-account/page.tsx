    ...
    <div className="min-h-screen flex flex-col bg-background text-foreground overflow-y-auto">
      ...
      <main className="flex-1 max-w-2xl mx-auto w-full px-4 py-12">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-black text-foreground">Hesap Silme Talebi</h1>
            <p className="text-sm text-muted mt-0.5">KlinikIQ — Dr. Furkan Güven tarafından geliştirilmiştir</p>
          </div>
        </div>
        ...
        <div className="bg-surface-muted rounded-2xl border border-border p-6 mb-6">
          ...
          <div className="mt-4 space-y-2">
            <p className="text-xs text-muted font-bold uppercase tracking-wider">E-postanızda şunları belirtin:</p>
            <ul className="text-sm text-muted space-y-1.5 pl-3">
              <li className="flex items-start gap-2"><span className="text-foreground mt-0.5">•</span> KlinikIQ'ya kayıtlı e-posta adresiniz</li>
              <li className="flex items-start gap-2"><span className="text-foreground mt-0.5">•</span> "Hesap Silme Talebi" konu başlığı</li>
            </ul>
          </div>
          <p className="text-xs text-muted mt-4">
            Talebiniz <span className="text-foreground font-bold">7 iş günü</span> içinde işleme alınır ve size bilgi verilir.
          </p>
        </div>
        ...
        <div className="bg-surface-muted rounded-2xl border border-border p-6 mb-6">
          ...
          <p className="text-sm text-muted mb-3">Hesap silme talebinizin onaylanmasının ardından aşağıdaki veriler kalıcı olarak silinir:</p>
        ...
        <div className="bg-surface-muted rounded-2xl border border-border p-6">
          ...
          <p className="text-sm text-muted leading-relaxed">
            ...
            <span className="text-foreground font-bold"> Ayarlar → Oturumu Kapat</span> adımlarını izleyin.
