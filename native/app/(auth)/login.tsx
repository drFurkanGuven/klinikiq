...
const PRIVACY_URL = "https://klinikiq.furkanguven.space/privacy";
...
export default function LoginScreen() {
  ...
  return (
    ...
    >
      ...
      >
        <View style={[styles.formWrap, isTablet && { maxWidth: authMaxWidth, alignSelf: "center", width: "100%" }]}>
          ...
          <Text style={[styles.registerLine, { color: theme.textMuted }]}>
            Hesabın yok mu?{" "}
            <Link href="/(auth)/register" style={{ color: theme.accent, fontWeight: "700" }}>
              Kayıt ol
            </Link>
          </Text>
